...
export const PERSONAS = {
  // languageMatters: whether asking the language preference is graded. Off for every customer:
  // it stays a Mémo reminder and never costs points (user decision).
  rhume: {
    name: "Mme Imane",
...
- Quand le pharmacien te propose un ou plusieurs produits sans expliquer comment les prendre, ne pars pas : demande-lui comment utiliser chacun (quand, combien de fois, pendant combien de temps). Une seule question par produit, jamais deux fois la même.
- Ne pars que lorsque le pharmacien a expliqué l'utilisation de ce qu'il te conseille, ou qu'il te dit au revoir, ou qu'il t'envoie consulter un médecin : alors remercie, dis au revoir et termine ton message par [FIN]. Après 8 réponses du pharmacien au plus, conclus poliment de la même façon.`;
