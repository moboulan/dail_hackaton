...
// What each customer hides until asked lives on the server (step 4), not here.
...
export const MODULES = [
  {
    ...
    products: [
      ...
      { name: "Décongest Nuit", form: "Comprimés", forWhat: "Nez très bouché la nuit.", use: "Le soir.", caution: "Contre-indiqué si tension élevée, problème cardiaque ou grossesse." },
    ],
    quiz: [
      {
        id: "q1",
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Bronz'Express", form: "Autobronzant", forWhat: "Donner un teint hâlé.", use: "Sur peau propre et saine.", caution: "Ne protège pas du soleil. Pas sur une peau brûlée." },
    ],
    quiz: [
      {
        id: "q1",
  ...
  },
  {
    ...
    products: [
      ...
      { name: "Spasmo Doux", form: "Comprimés", forWhat: "Crampes légères.", use: "Au moment de la crampe.", caution: "Peut masquer un problème grave : pas si douleur forte ou fièvre." },
    ],
    quiz: [
      {
        id: "q1",
